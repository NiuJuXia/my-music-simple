  ...
  <div class="player" v-show='playlist.length>0'>
    ...
    <div class="normal-player" v-show='fullScreen'>
      ...
      <div class="top">
        ...
        <h1 class='title' v-html="currentSong.name">777</h1>
        <h2 class='subtitle' v-html="currentSong.singer">7777</h2>
      </div>
      <div class="middle"
    ...
    <div class="mini-player" v-show='!fullScreen'  @click="open">
      <div class="icon">
        <div class="imgWrapper" ref="miniWrapper">
          <img  width="40" height="40" :src="currentSong.image" :class="cdCls" ref="miniImage">
        </div>
      </div>
      <div class="text">
    ...
    <audio ref="audio" :src='currentSong.url' @error="error" @playing="ready"
...
export default {
  ...
  methods: {
    ...
    syncWrapperTransform (wrapper, inner) { // 特别有意思，日后详查
        ...
        .cd-wrapper
          ...
          .cd
            ...
            .image
              ...
              box-sizing: border-box
              border-radius: 50%
              border: vw(10) solid rgba(255, 255, 255, 0.1)
    .top
      position: relative
      margin-bottom: vw(20)
      .title
